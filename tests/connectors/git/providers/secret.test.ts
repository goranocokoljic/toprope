...
describe('loadServerKey — fail-closed key loading (#194)', () => {
    ...
    it('accepts a key generated by generateServerKeyBase64', () => {
        const generated = generateServerKeyBase64();
        const result = loadServerKey({[SECRET_KEY_ENV]: generated});
