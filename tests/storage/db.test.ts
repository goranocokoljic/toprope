...
describe('getMigrationStatus', () => {
    ...
    it('returns one entry per migration after all are applied', () => {
        ...
        expect(statuses).toHaveLength(32);
    });
...
describe('table creation', () => {
    ...
    it('creates the user_preferences table', () => {
        expect(tableExists('user_preferences')).toBe(true);
    });

    it('creates the plan_change_events table', () => {
        expect(tableExists('plan_change_events')).toBe(true);
    });

    it('creates the self_reports table', () => {
        expect(tableExists('self_reports')).toBe(true);
    });
});
